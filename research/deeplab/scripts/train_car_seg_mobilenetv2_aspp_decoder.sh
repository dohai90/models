...
#   sh ./scripts/train_car_seg_mobilenetv2_aspp_decoder.sh
#
#
...
EXP_FOLDER="exp/train_car_seg_mobilenetv2_aspp_decoder"
...
cd "${INIT_FOLDER}"
if [ ! -d "${CKPT_NAME}" ]; then
  ln -s "/content/dohai90/pretrained_models/deeplabv3_mnv2_pascal_train_aug"
fi
cd "${CURRENT_DIR}"
